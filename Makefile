output: main.o Neuron.o Layer.o Matrix.o Math.o NeuralNetwork.o feedForward.o Backpropogation.o setErrors.o Constructor.o Misc.o Classifier.o SaveWeights.o
	g++ -std=c++17 -Wall -fexceptions main.o Neuron.o Layer.o Matrix.o Math.o NeuralNetwork.o feedForward.o Backpropogation.o setErrors.o Constructor.o Misc.o Classifier.o SaveWeights.o -o output

main.o: main.cpp
	g++ -std=c++17 -Wall -fexceptions -c main.cpp
